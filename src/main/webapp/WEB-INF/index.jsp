                ...
                <form action="/addTodo" method="post">
                    <div class="col">
                        <input class="form-control form-control-lg border-0 add-todo-input bg-transparent rounded"
                               type="text" placeholder="Add new .." name="todoText">
                    </div>
                    <div class="col-auto m-0 px-2 d-flex align-items-center">
                        ...
                        <input type="hidden" name="dueDate" class="due-date-input"> <!-- Поле для даты -->
                    </div>
        ...
        <div class="col mx-auto">
            <%
                ...
                if (request.getSession().getAttribute("user") != null) {
                    toDos = (List<ToDo>) request.getAttribute("toDos");
                }
            %>
            <%for (ToDo toDo : toDos) {%>
            <div class="row px-3 align-items-center todo-item rounded">
                ...
                <div class="col-auto m-1 p-0 d-flex align-items-center">
                    <h2 class="m-0 p-0">
                        <a href="/finishToDo?id=<%=toDo.getId()%>">
                ...
                <div class="col-auto m-1 p-0 todo-actions">
                    <div class="row d-flex align-items-center justify-content-end">
                        <h5 class="m-0 p-0 px-2">
                            <a href="/editToDo?id=<%=toDo.getId()%>"><i class="fa fa-pencil text-info btn m-0 p-0"
                                                                        data-toggle="tooltip" data-placement="bottom"
                                                                        title="Edit todo"></i></a>
                        </h5>
                        <h5 class="m-0 p-0 px-2">
                            <a href="/deleteToDo?id=<%=toDo.getId()%>"><i class="fa fa-trash-o text-danger btn m-0 p-0"
                                                                          data-toggle="tooltip"
